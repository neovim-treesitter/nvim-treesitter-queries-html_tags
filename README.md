# nvim-treesitter-queries-html_tags

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-html_tags/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-html_tags/actions/workflows/validate.yml)

Neovim tree-sitter queries for **html_tags**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-html_tags",
...
- [ ] Changes are scoped to `html_tags` — do not include files for other languages
